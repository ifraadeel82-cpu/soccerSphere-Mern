...
const Sidebar = ({ links }) => {
  ...
  return (
    <aside style={{width:240,height:'100vh',background:'#161616',borderRight:'1px solid #2a2a2a',display:'flex',flexDirection:'column',position:'fixed',top:0,left:0,zIndex:50,overflow:'hidden'}}>
      <div style={{padding:'24px 20px',borderBottom:'1px solid #2a2a2a',flexShrink:0}}>
      ...
      <div style={{padding:'16px 12px',borderTop:'1px solid #2a2a2a',flexShrink:0}}>
